...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1596560548464-f010549e45d8?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80',
    category: 'social-media',
    subcategory: 'tiktok'
  },
  {
...
export const productCategories: ProductCategoryDetail[] = [
  {
    ...
    description: 'Top up Diamond untuk Mobile Legends: Bang Bang dengan harga terbaik',
    image: 'https://images.unsplash.com/photo-1560419015-7c427e8ae5ba?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'igf-10', name: '25000 Followers', quantity: 25000, price: 1500000 }
    ]
  },
  {
    id: 'instagram-likes',
    category: 'instagram',
    name: 'Instagram Likes',
    description: 'Tambah likes untuk postingan Instagram Anda dengan harga terbaik',
    image: 'https://images.unsplash.com/photo-1611262588024-d12430b98920?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'tkf-10', name: '25000 Followers', quantity: 25000, price: 1800000 }
    ]
  },
  {
    id: 'tiktok-likes',
...
export function getProductCategoryById(id: string): ProductCategoryDetail | undefined {
  return productCategories.find(prod => prod.id === id);
}

// Fungsi utilitas untuk mendapatkan opsi produk berdasarkan ID kategori dan ID opsi
export function getProductOption(categoryId: string, optionId: string): ProductOption | undefined {

    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Layanan top up game dan social media terpercaya dengan harga
              terbaik dan proses cepat.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/liboyy_store26/"
        ...
        <div className="border-t border-gray-700 pt-6 text-center text-gray-500 text-sm">
          <p>
            &copy; {new Date().getFullYear()} LiboyyStore.ID. All rights
            reserved.
          </p>
        </div>
        <p className="mt-2">
          Developed by{" "}
          <a
            href="https://www.instagram.com/azrlrsdi_/"
            target="_blank"
